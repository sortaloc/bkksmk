        ...
        <div class="col-11">
            <div class="card box btn-squre">
                ...
                <div class="card-body p-0">
                    <form action="{{ url('admin/berita/add') }}" method="post" enctype="multipart/form-data" class="p-3">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="judul_berita" type="text" class="form-control{{ $errors->has('judul_berita') ? ' is-invalid' : '' }}" name="judul_berita" value="{{ old('judul_berita') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="penulis" type="text" class="form-control{{ $errors->has('penulis') ? ' is-invalid' : '' }}" name="penulis" value="{{ old('penulis') }}" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea id="isi_berita" type="text" class="form-control{{ $errors->has('isi_berita') ? ' is-invalid' : '' }} summernote" name="isi_berita" required>{{ old('isi_berita') }}</textarea>
                        ...
                        <div class="form-group row m-0 p-0">
                            <button type="submit" class="btn btn-primary btn-block btn-square">
                                <i class="fas fa-plus"></i> {{ __('Tambah Berita') }}
                            </button>
                        </div>
                    </form>
                </div>
