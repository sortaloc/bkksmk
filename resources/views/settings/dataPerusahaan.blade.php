    ...
    <div class="row justify-content-center">
        <div class="col-11">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('perusahaan/settings/datadiri') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nama_perusahaan" type="text" class="form-control{{ $errors->has('nama_perusahaan') ? ' is-invalid' : '' }}" name="nama_perusahaan" value="{{ $perusahaan->nama_perusahaan }}" required autofocus>
